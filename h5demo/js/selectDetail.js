...
var JSEnvironment = {
    ...
    JqUlOne: $('<ul class="ulOne"><li class="noRight">不复权</li><ul>'),
...
function LoadEnvironment() {
    ...
    JSEnvironment.HistoryOption = {
        ...
        Windows: [
            ...
            //     Script: 'B1:=WEEK==1;\n\
            //     S1:=WEEK==4;\n\
            //     DRAWICON(B1,L*1.18,13);\n\
            //     DRAWICON(S1,H*0.83,14);',
            //     Name: "买卖指标",
            //     Modify: false,
            //     Change: false
            // },
            {
                ...
                API: {
                    Name: '买卖点指标',
                    Script: null,
                    // B1:=Boolean(myobj[isBuyPoint])===true  ;\n\
                    // S1:=Boolean(myobj[isSellPoint])===true ;\n\
                    // DRAWICON(B1,L*1.18,7); \n\
                    // DRAWICON(S1,H*0.83,8);',
                    Args: null,
...
function resizeCanvas() { //分钟走势图宽，高
    ...
    var trueWidthM = document.getElementsByTagName('body')[0].clientWidth;
    console.log(trueWidthM);
...
function updateMinuteChart(options) { //更新分时图
    ...
    var trueWidth = document.getElementsByTagName('body')[0].clientWidth * 0.75;
