...
JSIndexScript.prototype.MarginProportion = function () {
    let data = {
        ...
        IsMainIndex: false,
        Condition: {
            Period: [CONDITION_PERIOD.KLINE_DAY_ID]
        },
        Args: [],
        Script: //脚本
            '占比:MARGIN(2);'
...
JSIndexScript.prototype.UpDownAnalyze = function () {
    let data = {
        ...
        FloatPrecision: 0,
        Condition: {
            Period: [CONDITION_PERIOD.MINUTE_ID, CONDITION_PERIOD.MULTIDAY_MINUTE_ID, CONDITION_PERIOD.KLINE_DAY_ID]
        },
        Args: [],
        Script: //脚本
...
JSIndexScript.prototype.VOLRate = function () {
    let data = {
        ...
        IsMainIndex: false,
        Condition: {
            Period: [CONDITION_PERIOD.MINUTE_ID, CONDITION_PERIOD.MULTIDAY_MINUTE_ID]
        },
        Args: [],
        Script: //脚本
            "LIANGBI:VOLR;"
